...
/**
 * Plugin Name: My Kallyas Element
...
class Zn_My_Kallyas_Element_Plugin_Demo{
	...
	function show_admin_notice(){
		...
		$buy_link = sprintf( '<a class="button button button-primary" href="%1$s" target="_blank">%2$s</a>', $buy_kallyas_url, __( 'Get Kallyas theme from here', 'my-kallyas-element-demo' ) );
		$message = __( 'Kallyas theme is not installed! My Kallyas Element only works with Kallyas theme.', 'my-kallyas-element-demo' );
...
Zn_My_Kallyas_Element_Plugin_Demo::get_instance();